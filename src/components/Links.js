...
const Links = () => {
    return (
        <section id="contacts" className="flex flex-col justify-center bg-[#252525] mx-1 mt-1 p-2 min-h-60 gap-3 dark:bg-[#DDDDDD] duration-300">
            <div className="flex justify-center items-center">
                <p className="font-bold text-[#DC4F25] text-xl font-titleFont">Links</p>
            </div>
