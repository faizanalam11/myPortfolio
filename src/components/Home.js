...
const Home = () => {
    ...
    <section id="home" className="flex text-[#ECEEEF] bg-[rgb(31,31,31)] px-2 py-1 m-1 justify-center items-center min-h-60 dark:bg-[#DDDDDD] duration-300 dark:text-[rgb(31,31,31)]">
        <div className="flex flex-col sm:flex-row justify-around w-5/6">
            <div className="flex flex-col gap-3 w-2/3 order-2 sm:order-2 justify-center">
            ...
            <div className="w-1/3 flex justify-center items-center order-1 sm:order-2">
